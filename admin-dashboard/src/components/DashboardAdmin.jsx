...
const DashboardAdmin = () => {
  ...
  const [content, setContent] = useState("Ini adalah konten dashboard admin.");
    ...
    <div className="flex flex-col min-h-screen bg-[#F1EFDC]">
      ...
      <div className="flex-1 p-5">
        <div className="flex space-x-5">
          <Link to="/testimoni" className="text-[#D36B00] hover:text-[#42032C]">Testimoni</Link>
          <Link to="/product" className="text-[#D36B00] hover:text-[#42032C]">Produk</Link>
        </div>
