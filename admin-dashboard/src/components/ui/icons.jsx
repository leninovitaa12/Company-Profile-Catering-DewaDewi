...
const AnimatedIcon = ({ children, className = "" }) => {
  return (
    <motion.div className={`text-current ${className}`} whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }}>
      {children}
    </motion.div>
  )
}
...
export const TestimoniIcon = ({ className = "" }) => (
  <AnimatedIcon className={className}>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export const ProfilIcon = ({ className = "" }) => (
  <AnimatedIcon className={className}>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
